...
import br.gov.caixa.sigct.client.SOAPException;
...
public class ConsumesTermsTest {	
	
	private final static Logger LOGGER = Logger.getLogger(ConsumesTermsTest.class.getName());
	

	public static void main(String[] args)  {
		       	
	        ConsumesTerms object = new ConsumesTerms();	
	        ...
	        try {
	        object.consumesTerms(login, password, site, contract, invoice);	  
	        }
	        
	        catch(SOAPException_Exception e) {
	        	
	        	 LOGGER.log(Level.WARNING, "Horário não permitido para acessar");
	        }
